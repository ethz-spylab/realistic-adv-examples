...
from src.attacks.rays import RayS
...
```bash
  -  python3 main.py --dataset inception --epsilon 0.05
```
* Run attacks on a naturally trained model (Resnet):
```bash
  -  python3 main.py --dataset resnet --epsilon 0.05
```
* Run attacks on a naturally trained model (Cifar):
```bash
  - python3 main.py --dataset cifar --epsilon 0.031
```
* Run attacks on a naturally trained model (MNIST):
```bash
  - python3 main.py --dataset mnist --epsilon 0.3
```
